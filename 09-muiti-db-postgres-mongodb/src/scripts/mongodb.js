...
// --- Update
db.herois.update({ _id: ObjectId("5e85532ed827637543e83b3f")}, {nome: 'Mulher Maravilha'})

db.herois.update({ _id: ObjectId("5e8553e2d827637543e83b53")}, { $set: {nome: 'Lanterna Verde'} })
